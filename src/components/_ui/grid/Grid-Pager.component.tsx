...
export const GridPager = memo((
    ...
    let end = (Math.floor(currentPage/itemsPerPage)+1)*itemsPerPage;
    ...
    return (
        <div className='flex justify-center items-center w-full'>
                ...
                <div className={`flex pager-span items-center justify-center w-8 text-sm font-normal ${start+1 > 0 ? ' cursor-pointer':' opacity-30'}`} 
            ...
            {[...Array(totalPage)].map((value,index)=>(
                ...
                <div className={`flex pager-span items-center justify-center w-8 text-sm font-normal ${end < (totalPage || 1) ? ' cursor-pointer':' opacity-30'}`}
