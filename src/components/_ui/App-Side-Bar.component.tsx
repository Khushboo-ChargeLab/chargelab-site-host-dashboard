    ...
    <div className='w-60 bg-white h-full block pl-5 pr-5 absolute'>
      ...
      <div
        ...
        className={`flex items-center w-50 pr-20 cursor-pointer rounded mt-2 ${
          active.path === menu[1].path ? 'bg-silver' : ''
        }`}
      >
        <img
          src={active.path === menu[1].path ? chargerSelected : chargers}
          alt=''
        ...
        <Label
          ...
          className={active.path === menu[1].path ? 'text-blue2' : 'text-grey6'}
        />
      </div>
      <div
        onClick={() => navigate(menu[2])}
        className={`flex items-center w-50 pr-20 cursor-pointer rounded ${
          active.path === menu[2].path ? 'bg-silver' : ''
        }`}
      >
        <img
          src={active.path === menu[2].path ? pricingS : pricing}
          alt=''
          className='pt-2 pb-2 pl-4 pr-4'
        />
        <Label
          text='Pricing'
          type={LabelType.LABEL_S_G6}
          className={active.path === menu[2].path ? 'text-blue2' : 'text-grey6'}
        />
      </div>
      <div
        onClick={() => navigate(menu[3])}
        className={`flex items-center w-50 pr-20 cursor-pointer rounded ${
          active.path === menu[3].path ? 'bg-silver' : ''
        }`}
      >
        <img
          src={active.path === menu[3].path ? accessS : access}
          alt=''
          className='pt-2 pb-2 pl-4 pr-4'
        />
        <Label
          text='Access'
          type={LabelType.LABEL_S_G6}
          className={active.path === menu[3].path ? 'text-blue2' : 'text-grey6'}
        />
      </div>
      ...
      <div
        ...
        className={`flex items-center w-50 pr-20 cursor-pointer rounded mt-2 ${
          active.path === menu[4].path ? 'bg-silver' : ''
        }`}
      >
        <img
          src={active.path === menu[4].path ? chargerSelected : company}
          alt=''
          className='pt-2 pb-2 pl-4 pr-4'
        />
        <Label
          text='Company'
          type={LabelType.LABEL_S_G6}
          className={active.path === menu[4].path ? 'text-blue2' : 'text-grey6'}
        />
      </div>
      <div
        onClick={() => navigate(menu[5])}
        className={`flex items-center w-50 pr-20 cursor-pointer rounded ${
          active.path === menu[5].path ? 'bg-silver' : ''
        }`}
      >
        <img
          src={active.path === menu[5].path ? chargerSelected : payout}
          alt=''
          className='pt-2 pb-2 pl-4 pr-4'
        />
        <Label
          text='Payout'
          type={LabelType.LABEL_S_G6}
          className={active.path === menu[5].path ? 'text-blue2' : 'text-grey6'}
        />
      </div>
      <div
        onClick={() => navigate(menu[6])}
        className={`flex items-center w-50 pr-20 cursor-pointer rounded ${
          active.path === menu[6].path ? 'bg-silver' : ''
        }`}
      >
        <img
          src={active.path === menu[6].path ? chargerSelected : rfid}
          alt=''
          className='pt-2 pb-2 pl-4 pr-4'
        />
        <Label
      ...
      <div
        onClick={() => navigate(menu[7])}
        className={`flex items-center w-50 pr-20 cursor-pointer rounded mt-2 ${
          active.path === menu[7].path ? 'bg-silver' : ''
        }`}
      >
        <img
          src={active.path === menu[7].path ? chargerSelected : learning}
          alt=''
          className='pt-2 pb-2 pl-4 pr-4'
        />
        <Label
          text='Learning'
          type={LabelType.LABEL_S_G6}
          className={active.path === menu[7].path ? 'text-blue2' : 'text-grey6'}
        />
      </div>
      <div
        onClick={() => navigate(menu[8])}
        className={`flex items-center w-50 pr-20 cursor-pointer rounded ${
          active.path === menu[8].path ? 'bg-silver' : ''
        }`}
      >
        <img
          src={active.path === menu[8].path ? chargerSelected : help}
          alt=''
          className='pt-2 pb-2 pl-4 pr-4'
        />
        <Label
          text='Help'
          type={LabelType.LABEL_S_G6}
          className={active.path === menu[8].path ? 'text-blue2' : 'text-grey6'}
        />
      </div>
    </div>
  );
