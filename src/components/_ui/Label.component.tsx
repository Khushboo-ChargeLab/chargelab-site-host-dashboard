...
export enum LabelType {
  ...
  BUTTON_PRIMARY = "text-base font-bold font-sans text-white",
  BUTTON_CANCEL = "text-base font-bold font-sans text-black",
  BUTTON_DISABLE = "text-base font-bold font-sans text-grey-light2",
  BUTTON_INFO = "text-base font-bold font-sans text-[#18A0D7]",
  BUTTON_ALERT = "text-base font-bold font-sans text-white",
}
