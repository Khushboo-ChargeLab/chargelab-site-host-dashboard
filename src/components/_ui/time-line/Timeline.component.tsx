...
const renderItem = (
  ...
  <div key={`${row.title}-${index}`} className="flex items-center relative ">
    <div className="border-r-2 border-black absolute h-full left-1 top-2 mb-10 z-0" />
    <div className="w-5 h-5 rounded-full bg-white top-0.5 -left-1 absolute z-9" />
    <div className="w-2.5 h-2.5 rounded-full bg-black top-2 absolute z-10" />
...
export default memo<TimelineProps>(Timeline);
