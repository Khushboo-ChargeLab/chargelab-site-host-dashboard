...
import { login, resendCode, setBearerToken, setUserInfo, verifyCode } from '../../services/authenticate/authenticate.service';
    ...
    <div className="m-auto bg-white rounded p-5">
      ...
      {step === 0 && (
        <>
          ...
          <div className="mb-4">
            <Button size={ButtonSize.FULL} label="Next" type={!email || loading ? ButtonType.Disabled : ButtonType.Primary} onClick={goNext} />
          </div>
        </>
      )
      }
      {step === 1 && (
        <>
          <div className="mb-8">
            <FormInput placeholder='Enter the code you received' onChange={emailChanged} />
          </div>
          <div className="mb-4">
            <Button size={ButtonSize.FULL} label="Login" type={!email || loading ? ButtonType.Disabled : ButtonType.Primary} onClick={goNext} />
          </div>
