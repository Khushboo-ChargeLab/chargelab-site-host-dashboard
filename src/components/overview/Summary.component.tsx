...
import { Card, DateTimePicker, Label, LabelType } from '../_ui';
      ...
      <div className='flex items-center mt-4'>
        <div className='block text-center flex-grow h-36'>
          <Label
            ...
            text='Fees collected'
            className='ml-15 pt-7'
          />
          <Label
            type={LabelType.H1}
            text={handleFeesCollectedDisplay(statsSelector)}
            className='ml-15 pt-4 pb-7'
          />
        </div>
        ...
        <div className='block text-center flex-grow  h-36'>
          ...
          <Label
            type={LabelType.H1}
            text={handleEnergyUsedDisplay(statsSelector)}
            className='ml-15 pt-4 pb-7'
          />
        </div>
        <div className='block ml-1 mr-1 divider'>&nbsp;</div>
        <div className='block text-center flex-grow  h-36'>
          ...
          <Label
            type={LabelType.H1}
            text={
              statsSelector?.stats?.[0]
                ? statsSelector?.stats?.[0]?.transactions
                : '0'
            }
            className='ml-15 pt-4 pb-7'
          />
