  ...
  return (
    <div className='flex flex-row'>
      ...
      <Label
        text={
          endTime && timeZone
            ? formatInTimeZone(endTime, timeZone, 'LLL dd, yyyy h:mm a')
            : ''
        }
    ...
    return (
      <div className='flex flex-row'>
        ...
        <Label
          text={
            startTime && timeZone
              ? formatInTimeZone(startTime, timeZone, 'LLL dd, yyyy h:mm a')
              : ''
          }
          type={LabelType.BODY3}
        />
      ...
      <div className='flex flex-row'>
        ...
        <div className='flex flex-row gap-4'>
          ...
          <div className='flex flex-row gap-1'>
            ...
            <Label text={sessionData.connector} type={LabelType.BODY3} />
          </div>
        </div>
      </div>
      <div className='flex flex-row'>
